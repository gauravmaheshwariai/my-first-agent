...
<head>
<meta charset="UTF-8">
<title>{story['title']} (Gemini)</title>
<style>
    body {{
...
<body>
<h1>{story['title']} <small>(Gemini version)</small></h1>
"""]
...
if __name__ == "__main__":
    ...
    with open("gemini_storybook.html", "w", encoding="utf-8") as f:
        f.write(html)

    print("Saved gemini_storybook.html — open it in your browser!")